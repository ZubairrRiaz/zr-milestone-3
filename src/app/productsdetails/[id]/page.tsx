  ...
  return (
    <div className="font-[family-name:var(--font-geist-sans)] sm:h-screen sm:w-[80%] mx-auto sm:flex sm:justify-evenly items-center sm:my-10 p-6 bg-gradient-to-r from-[#9fc6d2] to-[#4a4e69] sm:rounded-xl shadow-xl">
      <div className='flex justify-center'>
        <Image height={250} width={250} src={product[0].image} alt={product[0].name} className="sm:w-[400px] h-[90%] rounded-xl" />
      </div>
      <div className="mt-6 sm:space-y-8">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-[#4a4e69]">{product[0].name}</h1>
        ...
        <div className="mt-2 text-sm text-white sm:text-xl">Reviews: {product[0].reviews}</div>
